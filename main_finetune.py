...
def get_args_parser():
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval_epoch', default=1, type=int, help='how many epoch to evaluate once')
...
def main(args):
    ...
    class_idx_map = dataset_train.class_to_idx
    ...
    if args.eval:
        test_stats = evaluate(data_loader_val, model, device, class_idx_map, args.visualize_epoch, args.max_num)
